...
int main() {
	...
	ModernText kongfa(mfont, Vec2(3000, 300), Vec2(20, 300), L"À“°«—ππ’È ©—π°‘πµ—Èß‡¬Õ– æ√ÿËßπ’È ©—π®–°‘π‚§µ√‡¬Õ–", textStyle, 1);
	ModernText dsadkongfa(mfont, Vec2(3000, 300), Vec2(20, 500), L"A list of bit flags used in the ëface_flagsí field of the FT_FaceRec structure. They inform client applications of properties of the corresponding face.", Color(255, 255, 255, 255), Color(0, 0, 0, 255), 1);
	//kongfa.oneLine = true;
